...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "raghuschandra-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/mkr"
  #   chef.validation_client_name = "mkr-validator"
  #   chef.validation_key_path = ".chef/mkr-validator.pem"
  # end
end
